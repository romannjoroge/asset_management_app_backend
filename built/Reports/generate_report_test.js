...
import { ItemsThatDontNeedJoin, ItemsThatNeedJoin, SupportedGenerateAssetReportFields, WaysToFilterBy } from "./generated_report_types.js";
...
function test() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let listWithBothNeedAndNotNeedJoin = [];
        ...
        try {
            ...
            assert(result === true, `Wrong Result Returned: ${result}`);
        ...
        try {
            ...
            assert(result === false, `Wrong Result Returned: ${result}`);
        ...
        try {
            ...
            assert(statement === `SELECT a.${SupportedGenerateAssetReportFields.SERIAL_NUMBER}, a.${SupportedGenerateAssetReportFields.ACQUISITION_DATE}, a.${SupportedGenerateAssetReportFields.ACQUISITION_COST}, a.${SupportedGenerateAssetReportFields.RESIDUAL_VALUE}, a.${SupportedGenerateAssetReportFields.USEFUL_LIFE}, a.${SupportedGenerateAssetReportFields.BARCODE}, a.${SupportedGenerateAssetReportFields.DESCRIPTION}, a.${SupportedGenerateAssetReportFields.DISPOSAL_DATE}, a.${SupportedGenerateAssetReportFields.ISCONVERTED}, a.${SupportedGenerateAssetReportFields.CONDITION}, c.name AS category, l.name AS location_name, u.username AS responsible_user, c.depreciationtype AS depreciationtype FROM Asset a INNER JOIN Category c ON c.id = a.categoryid INNER JOIN Location l ON l.id = a.locationid INNER JOIN User2 u ON u.id = a.responsibleuserid WHERE c.id = $1`, `Wrong Statement Returned ${statement}`);
            assert.deepEqual(args, [1], "Wrong Args Returned");
        ...
        try {
            ...
            assert.deepEqual(args, [1, 1, fromDate, toDate], "Wrong Args Returned");
...
test();
//# sourceMappingURL=generate_report_test.js.map