...
var SupportedGenerateAssetReportFields;
...
var GenerateAssetReportTimePeriods;
...
function getGenerateReportStruct(items) {
    try {
...
function getSelectFromField(field) {
    try {
...
function getSelectInnerJoinFromField(field) {
    try {
        if (field === SupportedGenerateAssetReportFields.LOCATION) {
...
function generateSelectStatementFromGenerateReportStruct(struct) {
    try {
...
function test2() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield storeGenerateReportStatement([SupportedGenerateAssetReportFields.ACQUISITION_COST], "Test Report", "monthly", 6);
            console.log("Done");
        }
        catch (err) {
