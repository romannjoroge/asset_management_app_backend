...
app.post('/signup', body('password', "Password Should Be At Least 8 characters long").isLength({ min: 8 }), body('email', "Enter a Valid Email").isEmail(), (req, res) => {
    // Get details from user
    let { fname, lname, email, password, username, companyName, } = req.body;
    // Validate details
