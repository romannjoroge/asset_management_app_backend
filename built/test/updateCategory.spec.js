...
describe.skip("updateCategory Test", function () {
    it("should update depreciation type is double declining, value is 0 and the other details are valid", function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // Run function
            try {
                yield Category.updateCategory(updateJSON, categoryName);
    ...
    it("should pass when depreciation type is written down, value is 200 and the rest is fine", function () {
        return __awaiter(this, void 0, void 0, function* () {
            // Test inputs
            let updateJSON = {
                name: "NewCategory",
