...
describe.skip("verifyCategoryName test", function () {
    it("should deny a category name that is not a string", function () {
        return __awaiter(this, void 0, void 0, function* () {
            // Test input
            let newName = 1;
            // Run the function
            try {
                yield Category.verifyCategoryName(newName);
    ...
    it("should deny a category name that is too long", function () {
        return __awaiter(this, void 0, void 0, function* () {
            // Test input
    ...
    it("should deny a category name that already exists", function () {
        return __awaiter(this, void 0, void 0, function* () {
            // Test input
    ...
    it("should accept a category name that is of the right type, length and does not exist", function () {
        return __awaiter(this, void 0, void 0, function* () {
            // Test input
            ...
            // Run function
            try {
                const result = yield Category.verifyCategoryName(newName);
...
describe.skip("updateCategoryName Test", function () {
    return __awaiter(this, void 0, void 0, function* () {
        it("should update category table if new category name is valid and old category exists", function () {
            return __awaiter(this, void 0, void 0, function* () {
                // Test inputs
                let newName = "Test2";
                ...
                // Call function
                try {
                    yield Category._updateCategoryName(newName, oldName);
        ...
        it("should deny updating a category that does not exist", function () {
            return __awaiter(this, void 0, void 0, function* () {
                // Test inputs
                let newName = "Valid";
        ...
        it("should deny updating a category's name to one that already exists", function () {
            return __awaiter(this, void 0, void 0, function* () {
                // Test inputs
                let oldName = "Existing";
                let newName = "Existing";
        ...
        it("should deny updating a categories name to an invalid one", function () {
            return __awaiter(this, void 0, void 0, function* () {
                // Test input
                let newName = 1;
                let oldName = "Existing";
