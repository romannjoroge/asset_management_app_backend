...
describe.skip("updateDepreciationType Test", function () {
    it("should fail when depreciation type is Straight Line and value is positive non zero number", function () {
    ...
    it("should fail when depreciation type is Written Value and value is 0", function () {
        return __awaiter(this, void 0, void 0, function* () {
            // test inputs
            let depType = "Written Down Value";
            let value = 0;
    ...
    it("should fail when Double Declining Balance has a non zero value", function () {
        return __awaiter(this, void 0, void 0, function* () {
            // test inputs
            let depType = "Double Declining Balance";
            let value = 120;
    ...
    it("should fail when Written Value has a negative depreciation value", function () {
        return __awaiter(this, void 0, void 0, function* () {
            // test inputs
            let depType = "Written Down Value";
            let value = -100;
    ...
    it("should fail when an invalid depreciation type is given", function () {
        return __awaiter(this, void 0, void 0, function* () {
            // test inputs
    ...
    it("should fail when depreciation type is of the wrong type", function () {
        return __awaiter(this, void 0, void 0, function* () {
            // test inputs
            let depType = 6;
            let value = 0;
    ...
    it("should pass when depreciation type is Double Declining Balance and value is 0", function () {
        return __awaiter(this, void 0, void 0, function* () {
            // test inputs
            let depType = "Double Declining Balance";
            let value = 0;
            ...
            // Run function
            try {
                yield Category._updateDepreciationType(depType, value, categoryName);
