...
describe.skip("updateAsset test cases", function () {
    function updateAssetShouldThrowError(updateAssetDict, errorMessage) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield Asset.updateAsset(updateAssetDict, assetTag);
    ...
    it("should return an error when given an invalid fixed status", function () {
        return __awaiter(this, void 0, void 0, function* () {
            // Test input
            let updateAssetDict = {
                fixed: "Wierd Value"
            };
            yield updateAssetShouldThrowError(updateAssetDict, "Invalid Fixed Status");
        });
    });
    it("should return an error when given an invalid asset life span", function () {
        return __awaiter(this, void 0, void 0, function* () {
            // Test input
            let updateAssetDict = {
                assetLifeSpan: -1
            };
            yield updateAssetShouldThrowError(updateAssetDict, "Invalid asset life span");
        });
    });
    it("should return an error when given an invalid acquisition date", function () {
        return __awaiter(this, void 0, void 0, function* () {
            // Test input
            let updateAssetDict = {
                acquisitionDate: "Wack Ass Date"
            };
            yield updateAssetShouldThrowError(updateAssetDict, "Invalid acquisition date");
        });
    });
    it("should return an error when given an invalid location ID", function () {
        return __awaiter(this, void 0, void 0, function* () {
            // Test input
            let updateAssetDict = {
                locationID: "LOL"
            ...
            yield updateAssetShouldThrowError(updateAssetDict, "Invalid location");
        });
    });
    it("should return an error when given an invalid status", function () {
        return __awaiter(this, void 0, void 0, function* () {
            // Test inputs
            let updateAssetDict = {
                status: "LOLOLOLOOO"
            };
            yield updateAssetShouldThrowError(updateAssetDict, "Invalid status");
        });
    });
    it("should return an error when given a user that doesn't exist as a custodian", function () {
        return __awaiter(this, void 0, void 0, function* () {
            // Test inputs
            let updateAssetDict = {
            ...
            yield updateAssetShouldThrowError(updateAssetDict, "Invalid custodian");
        });
    });
    it("should return an error when given an invalid acquisition cost", function () {
        return __awaiter(this, void 0, void 0, function* () {
            // Test inputs
            let updateAssetDict = {
                acquisitionCost: -1
            };
            yield updateAssetShouldThrowError(updateAssetDict, "Invalid acquisition cost");
        });
    });
    it("should return an error when given an invalid insurance value", function () {
        return __awaiter(this, void 0, void 0, function* () {
            // Test inputs
            let updateAssetDict = {
                insuranceValue: -1
            };
            yield updateAssetShouldThrowError(updateAssetDict, "Invalid insurance value");
        });
    });
    it("should return an error when a non existent category is given", function () {
        return __awaiter(this, void 0, void 0, function* () {
            // Test inputs
            let updateAssetDict = {
            ...
            yield updateAssetShouldThrowError(updateAssetDict, "Invalid category");
        });
    });
    it("should return an error when an invalid attachment is given", function () {
        return __awaiter(this, void 0, void 0, function* () {
            // Test inputs
            let updateAssetDict = {
            ...
            let fsExistsSyncStub = Sinon.stub(fs, "existsSync")
                ...
                .returns(false);
            yield updateAssetShouldThrowError(updateAssetDict, "Invalid attachments");
        });
    });
    it("should return an error when a negative residual value is given", function () {
        return __awaiter(this, void 0, void 0, function* () {
            // Test inputs
            let updateAssetDict = {
                residualValue: -100
            };
            yield updateAssetShouldThrowError(updateAssetDict, "Invalid Residual Value");
        });
    });
    it("should return an error when a non negative residual value is given but depreciation type is not straight line", function () {
        return __awaiter(this, void 0, void 0, function* () {
            // Test inputs
            let updateAssetDict = {
                residualValue: 100
            ...
            yield updateAssetShouldThrowError(updateAssetDict, "Invalid Residual Value for the Depreciation Type");
        });
    });
    it("should run successfuly when valid information is given", function () {
        return __awaiter(this, void 0, void 0, function* () {
            // Test inputs
            let updateAssetDict = {
