                ...
                getAllCategories().then(categories => {
                    ...
                    pool.query(assetTable.getMaxAssetID).then(result => {
                        ...
                        for (var i = 0; i < excelFileData.length; i++) {
                            ...
                            // Formula
                            // Category code(2 digits) + Site code (2 digits) + assetID (7 digits) + status code (1 digit)
                            // Create barcode from assetID and category
                            let assetIDCode = maxAssetID.toString().padStart(7, "0");
                            let statusCode = "0";
                            let categoryCode = (_b = (_a = categories.find(category => category.name === excelFileData[i].category)) === null || _a === void 0 ? void 0 : _a.code.padStart(2, "0")) !== null && _b !== void 0 ? _b : "00";
                            let siteCode = (_c = locations.find(location => location.name === excelFileData[i].site)) === null || _c === void 0 ? void 0 : _c.id.toString().padStart(2, "0");
                            let barcode = categoryCode + siteCode + assetIDCode + statusCode;
