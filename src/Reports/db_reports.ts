...
const assetaudittrail = "SELECT u.name, u.username, ipaddress, timestamp, e.description, a.barcode AS item FROM Log l JOIN User2 u ON l.userid = u.id JOIN Events e ON l.eventid = e.id JOIN Asset a ON a.assetid = l.itemid WHERE u.id = $1 AND l.eventid = $2 AND l.timestamp BETWEEN $3 AND $4 ORDER BY timestamp";
const categoryaudittrail = "SELECT u.name, u.username, ipaddress, timestamp, e.description, c.name AS item FROM Log l JOIN User2 u ON l.userid = u.id JOIN Events e ON l.eventid = e.id JOIN Category c ON c.id = l.itemid WHERE u.id = $1 AND l.eventid = $2 AND l.timestamp BETWEEN $3 AND $4 ORDER BY timestamp";
const locationaudittrail = "SELECT u.name, u.username, ipaddress, timestamp, e.description, lo.name AS item FROM Log l JOIN User2 u ON l.userid = u.id JOIN Events e ON l.eventid = e.id JOIN Location lo ON lo.id = l.itemid WHERE u.id = $1 AND l.eventid = $2 AND l.timestamp BETWEEN $3 AND $4 ORDER BY timestamp";
const useraudittrail = "SELECT u.name, u.username, ipaddress, timestamp, e.description, u.username AS item FROM Log l JOIN User2 u ON l.userid = u.id JOIN Events e ON l.eventid = e.id WHERE u.id = $1 AND l.eventid = $2 AND l.timestamp BETWEEN $3 AND $4 ORDER BY timestamp";
const reportaudittrail = "SELECT u.name, u.username, ipaddress, timestamp, e.description FROM Log l JOIN User2 u ON l.userid = u.id JOIN Events e ON l.eventid = e.id WHERE u.id = $1 AND l.eventid = $2 AND l.timestamp BETWEEN $3 AND $4 ORDER BY timestamp"
const readeraudittrail = "SELECT u.name, u.username, ipaddress, timestamp, e.description, (SELECT CONCAT(l.name, ' ', CASE WHEN entry = true THEN 'Entry' ELSE 'Exit' END, ' Reader') FROM ReaderDevice r JOIN Location l ON l.id = r.locationid WHERE r.id = itemid LIMIT 1) AS item FROM Log l JOIN User2 u ON l.userid = u.id JOIN Events e ON l.eventid = e.id WHERE u.id = $1 AND l.eventid = $2 AND l.timestamp BETWEEN $3 AND $4 ORDER BY timestamp"
const gatepassaudittrail = "SELECT u.name, u.username, ipaddress, timestamp, e.description, (SELECT CONCAT(l.name, ' Gatepass') FROM Gatepass g JOIN Location l ON g.fromlocation = l.id WHERE g.id = itemid LIMIT 1) AS item FROM Log l JOIN User2 u ON l.userid = u.id JOIN Events e ON l.eventid = e.id WHERE u.id = $1 AND l.eventid = $2 AND l.timestamp BETWEEN $3 AND $4 ORDER BY timestamp"
const batchaudittrail = "SELECT u.name, u.username, ipaddress, timestamp, e.description, (SELECT CONCAT(l.name, ' Batch') FROM Batch b JOIN Location l ON b.locationid = l.id WHERE b.id = itemid LIMIT 1) AS item FROM Log l JOIN User2 u ON l.userid = u.id JOIN Events e ON l.eventid = e.id WHERE u.id = $1 AND l.eventid = $2 AND l.timestamp BETWEEN $3 AND $4 ORDER BY timestamp"
const inventoryaudittral = "SELECT u.name, u.username, ipaddress, timestamp, e.description, i.name AS item FROM Log l JOIN User2 u ON l.userid = u.id JOIN Events e ON l.eventid = e.id JOIN Inventory i ON i.id = l.itemid WHERE u.id = $1 AND l.eventid = $2 AND l.timestamp BETWEEN $3 AND $4 ORDER BY timestamp"
