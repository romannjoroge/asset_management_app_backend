...
const updateItem = 'UPDATE Assets.item SET name = $1, category_id = $2, purchase_amount = $3, purchase_date = $4, next_dep_date = $5, accum_dep = $6, isnew = $7, location_id = $8 WHERE item_id = $9'
